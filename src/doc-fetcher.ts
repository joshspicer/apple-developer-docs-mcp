...
import { formatJsonDocumentation, formatJsonDocumentationCached } from './doc-parsers.js';
 ...
 */
export async function fetchAppleDocJsonCached(url: string, maxDepth: number = 2, useCache: boolean = true): Promise<any> {
  try {
